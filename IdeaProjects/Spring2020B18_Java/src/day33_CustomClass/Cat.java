...
public class Cat {
    ...
    */
    ...
    public void drink(String drink){// when this mehtod is called it should pass me the information what this cat is drinking
    ...
    public String toString(){
        ...
        return name+", breed is "+breed+", color is "+color+ ", year is "+age;
