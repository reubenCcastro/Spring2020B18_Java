...
public class studentObject {
    ...
    public static void main(String[] args) {
        ...
        canGraduate.removeIf( p -> p.gpa <= 3.0 );// this method will remove whose gpa is less or equal to 3
                        // I only have two who have gpa>3 ==> size of my ArrayList canGraduate = 2

        System.out.println(canGraduate.size());
                        // how can we create a program that will print info of all students who can graduate?
                        // we can apply a loop
